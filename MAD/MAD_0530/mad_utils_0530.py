...
from . import gemini_api_utils_0530, prompt_utils_0530
...
def fill_snippets_by_token_budget(
    ...
    try:
        ...
        count_response_empty = gemini_api_utils_0530.execute_gemini_api_call(
    ...
    while low <= high:
        ...
        try:
            tokens_for_current_selection = (
                gemini_api_utils_0530.execute_gemini_api_call(
                    client.models.count_tokens,
                    logger,
                    model=model_name_for_counting,
    ...
    if selected_snippets:
        try:
            ...
            final_tokens_for_selected = gemini_api_utils_0530.execute_gemini_api_call(
                client.models.count_tokens,
                logger,
                model=model_name_for_counting,
...
def prepare_training_snippets_for_interest_id(
    ...
    model_input_token_limit_id = gemini_api_utils_0530.get_gemini_model_info(
        client,
        65536,
    ...
    try:
        ...
        model_info_dict = gemini_api_utils_0530.get_gemini_model_info(
            client=client,
        ...
        _temp_prompt_for_token_est = prompt_utils_0530.construct_interest_id_prompt(
            i_feat=i_feat,
        ...
        count_response_base_prompt = gemini_api_utils_0530.count_gemini_tokens(
            client=client,
