...
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_M.py" \
  ...
  --file_lsit 'Datasets/File_List/TSB-AD-M-Eva6.csv' \
  --save True
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_M.py" \
  --AD_Name=TSPulse_ZS_ensemble \
  --dataset_dir 'Datasets/TSB-AD-M/' \
  --file_lsit 'Datasets/File_List/TSB-AD-M-Tuning6.csv' \
  --save True \
...
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_U.py" \
  ...
  --file_lsit 'Datasets/File_List/TSB-AD-U-Eva6.csv' \
  --save True
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_U.py" \
  --AD_Name=TSPulse_ZS_ensemble \
  --dataset_dir 'Datasets/TSB-AD-U/' \
  --file_lsit 'Datasets/File_List/TSB-AD-U-Tuning6.csv' \
  --save True \
...
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_M.py" \
  --AD_Name=TSPulse_ZS_ensemble \
  --dataset_dir 'Datasets/TSB-AD-M/' \
  --file_lsit 'Datasets/File_List/TSB-AD-M-Tuning7.csv' \
  --save True \
  --score_dir 'eval/score/multi-tuning/' \
  --save_dir 'eval/metrics/multi-tuning/'
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_U.py" \
...
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_U.py" \
  --AD_Name=TSPulse_ZS_ensemble \
  --dataset_dir 'Datasets/TSB-AD-U/' \
  --file_lsit 'Datasets/File_List/TSB-AD-U-Tuning7.csv' \
  --save True \
  --score_dir 'eval/score/uni-tuning/' \
  --save_dir 'eval/metrics/uni-tuning/'
