...
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_M.py" \
  ...
  --file_lsit 'Datasets/File_List/TSB-AD-M-Eva5.csv' \
  --save True
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_M.py" \
  --AD_Name=TSPulse_ZS_ensemble \
  --dataset_dir 'Datasets/TSB-AD-M/' \
  --file_lsit 'Datasets/File_List/TSB-AD-M-Tuning5.csv' \
  --save True \
...
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_U.py" \
  ...
  --file_lsit 'Datasets/File_List/TSB-AD-U-Eva5.csv' \
  --save True
python "${PROJECT_ROOT}/benchmark_exp/Run_Detector_U.py" \
  --AD_Name=TSPulse_ZS_ensemble \
  --dataset_dir 'Datasets/TSB-AD-U/' \
  --file_lsit 'Datasets/File_List/TSB-AD-U-Tuning5.csv' \
  --save True \
